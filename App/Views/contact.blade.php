                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-6 col-lg-6 direction text-right">
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        <li><a class="active text-right" href="/">خانه</a></li>
                                        <li class="text-right">دسته بندی‌ها <a class="text-center" href="#"> <i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="destination_details.html"  class="text-right">رستوران</a></li>
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="footer_widget text-center">
                        ...
                        <p class="direction"><i class="fa fa-location-arrow" aria-hidden="true"></i>گیلان، فومن، دانشکده فنی فومن<br>
